...
client.on("message", message => {
    if (message.content === (prefix + "jaki")) {
...
const prefix = '+'
    if (message.author.bot) return;
     if (message.content === prefix + "se") {
       if (message.author.id !== '489379054584201247') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
client.on('message', message => {
	var prefix = "+";
  if (!message.content.startsWith(prefix)) return;
  const verifed = ["489379054584201247"];
